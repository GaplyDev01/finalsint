...
import { BarChart3, Lock, AlertCircle, CheckCircle } from 'lucide-react';
...
const UpdatePasswordPage: React.FC = () => {
  ...
  useEffect(() => {
    // Check if the user is authenticated from the reset password flow
        ...
        <AnimatedElement animation="fade-in-up" delay={100}>
          ...
          {success && (
            <div className="mb-4 p-3 bg-green-500/10 border border-green-500/30 rounded-lg flex items-start">
              ...
              <span className="text-green-400 text-sm">Password updated successfully! Redirecting to dashboard...</span>
            </div>
          )}
          ...
          <form onSubmit={handleUpdatePassword} className="space-y-6">
            ...
            <div>
              <button
                ...
                className="w-full flex justify-center items-center py-2 px-4 border border-transparent rounded-lg shadow-sm text-white bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors disabled:opacity-50"
              >
                {loading ? (
